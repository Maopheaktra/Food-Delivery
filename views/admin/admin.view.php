                ...
                <div class="nav-user-wrapper">
                    ...
                    <button class="rounded-circle nav-user-btn dropdown-btn"
                        ...
                        <span class="nav-user-img">
                            <picture>
                                <source srcset="assets/images/user/<?= $adminPf['user_img'] ?>" type="image/webp"><img
                                    src="assets/images/user/<?= $adminPf['user_img'] ?>" alt="User name">
                            </picture>
                        </span>
                    </button>
                                ...
                                <td>
                                    ...
                                    <span class="p-relative">
                                        <button class="dropdown-btn transparent-btn "
                                            style="border-color: transparent !important;" type="button" title="More info">
                                            <div class="sr-only">More info</div>
                                            <i class="text-info" data-feather="more-horizontal" aria-hidden="true"
                                                style="color: initial; transition: color 0.3s;"
                                                onmouseover="this.style.color='red'"
                                                onmouseout="this.style.color='initial'"></i>
                                        </button>
                                        <ul class="users-item-dropdown dropdown shadow-none"
                                            style="border-color: transparent !important;">
                                            <li class="mx-2 mb-2 " style="border-color: transparent !important;"
                                                id="update-user"><a
            ...
            <div class="col-7 m-auto p-4 mt-3 bg-light rounded-3">
                <form class="add-user" action="../../controllers/admin/create_user.controller.php" method="post">
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <input type="text" class="col-9 form-control shadow-none" placeholder="James Smith"
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <input type="email" class="col-9 form-control shadow-none"
                            style="border-color: transparent !important;" placeholder="client@example.com" id="email"
                    ...
                    <div class="mb-3 d-flex align-items-center row">
                        <div class="pass-form-lab col-3 d-flex align-items-center">
                            <label for="create-password"
                                class="mx-3 bg-body-tertiary mt-1 form-label text-secondary">Password</label>
                        </div>
                        <div class="col input-group">
                            <input type="password" class="col-11 form-control border-white shadow-none"
                                id="create-password" placeholder="Your password should be at least 8 characters long"
                                name="password">
                            <button type="button" id="toggle-create-password-btn"
                                class="btn btn-secondary btn-outline-info border-2 text-white shadow-none"
                                style="margin-right:8px ; width: 50px; border-color: transparent !important;">
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <input type="number" class="col-9 form-control border-white shadow-none"
                            placeholder="(+855) 123456789" id="number" name="number" aria-describedby="numberHelp">
                    </div>
                    ...
                    <div class="d-flex row align-items-center">
                        ...
                        <div class="col d-flex bg-white p-2 form-control border-0 rounded"
                            style="margin-right:15px ; margin-left:5px ;">
                            <div class=" form-check col-3 d-flex align-items-center mx-3">
                                <input style="width: 20px; height: 20px; outline: 1.5px solid teal;"
                                    class="form-check-input shadow-none" type="radio" name="gender" id="maleRadio"
                                    value="M">
                            ...
                            <div class="form-check col d-flex align-items-center">
                                <input style="width: 20px; height: 20px; outline: 1.5px solid teal;"
                                    class="form-check-input shadow-none" type="radio" name="gender" id="femaleRadio"
                                    value="F">
                    ...
                    <div class="input-group mt-3">
                        ...
                        <select class="form-select text-secondary shadow-none"
                            style="border-color: transparent !important;" name="role" id="inputGroupSelect01">
                    ...
                    <div class="bottom-btn d-flex justify-content-end mt-3">
                        <input type="submit" class="mx-3 btn btn-primary shadow-none border-2 " name="send"
                            value="Add Now" />
                    ...
                    <form class="update-user" action="../../controllers/admin/edit.user.controller.php" method="post">
                        ...
                        <div class="row d-flex">
                            <div class="mb-3 col">
                                ...
                                <input type="text" class="form-control border-white shadow-none" id="username"
                            ...
                            <div class="mb-3 col">
                                ...
                                <input type="int" class="form-control border-white shadow-none" id="number" name="number"
                                    aria-describedby="numberHelp" value="<?= $_SESSION['popup']['phoneNumber'] ?>">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label text-secondary">Email address</label>
                            <input type="email" class="form-control border-white shadow-none" id="email" name="email"
                                aria-describedby="emailHelp" value="<?= $_SESSION['popup']['email'] ?>">
                        </div>
                        <div class="password-form-control mb-3">
                            <label for="update-password" class="form-label text-secondary">Password</label>
                            <div class="d-flex input-group">
                                <input type="password" class="col-12 form-control border-white shadow-none"
                                    id="update-password" value="<?= $_SESSION['popup']['password'] ?>" name="password">
                                <button type="button" id="toggle-update-password-btn"
                                    style="width: 50px; border-color: transparent !important;"
                                    class="btn btn-secondary btn-outline-info text-white border">
                        ...
                        <div class="input-group mb-3">
                            <input type="file" class="form-control shadow-none"
                                style="border-color: transparent !important;" id="inputGroupFile02">
                            <label class="input-group-text text-dark bg-outline-info" for="inputGroupFile02"><i
                        ...
                        <button type="submit" class="mt-2 btn btn-primary border-2 btn-outline-info text-white" name="send"
            ...
            <div id="profile-admin-popup"
                ...
                <div class="col-6 m-auto p-4 mt-3 bg-light rounded-3">
                    ...
                    <div class="show-info" style="width:100%;">
                        <input type="text" class="form-control shadow-none mb-3" placeholder="Username"
                            aria-label="username">
                        <input type="email" class="form-control shadow-none mb-3" placeholder="Email Address"
                            aria-label="email">
                        <input type="number" class="form-control shadow-none mb-3" placeholder="Phone Number"
                            aria-label="phone">
        ...
        <div class="show-pro row">
            ...
            <div class="profile-container d-flex justify-content-center">
                <label class="rounded-circle" for="imageInput" style="width: 100px; height: 100px;">
                    <img id="imagePreview" class="border border-5 rounded-circle" src="<?php $adminPf['user_img']; ?>" style="width: 100px; height: 100px;" alt="Preview" title="Upload profile">
                </label>
