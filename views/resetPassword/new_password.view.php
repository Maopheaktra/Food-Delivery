    ...
    <div class="card p-3" style="width:400px">
        <form action="" class="form-col">
            ...
            <div class="group-form">
                ...
                <input type="number" class="form-control" id="pwd" placeholder="Enter New Password">
            </div>
            <div class="group-form">
                <label for="confirm-pwd">New Password:</label>
                <input type="number" class="form-control" id="confirm-pwd" placeholder="Enter To Contirm Password">
            </div>
