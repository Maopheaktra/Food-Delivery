                ...
                <div class="bg-white rounded shadow-sm sticky_sidebar overflow-hidden">
                    <a href="profile.html" class>
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="right">
                                <h6 class="mb-1 font-weight-bold"><?= $accName['username']; ?> <i
                                        class="feather-check-circle text-success"></i></h6>
                                <p class="text-muted m-0 small"><span class="__cf_email__"
                                        data-cfemail="fd949c90928e9c959c93bd9a909c9491d39e9290"><?= $accName['email']; ?></span>
                                </p>
                            </div>
                        </div>
                    </a>
